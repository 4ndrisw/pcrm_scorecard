...
$sGroupBy = ' GROUP BY ' .db_prefix() . 'tasks.id, ' .db_prefix() . 'tasks.name, ' .db_prefix() . 'projects.name, '. db_prefix() . 'staff.firstname, ' . db_prefix() . 'staff.lastname,'   . db_prefix() . 'scorecards_tasks_history.dateadded';
