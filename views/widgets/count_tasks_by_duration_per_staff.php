...
<?php
    ...
    $scorecards = $CI->tasks_duration_model->get_count_tasks_by_duration_per_staff(get_staff_user_id());
?>
...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('count_tasks_by_duration_per_staff'); ?>">
    ...
    <div class="panel_s scorecards-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('count_tasks_by_duration_per_staff'); ?></p>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($scorecards as $scorecard) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $scorecard['count_duration']; ?></td>
                                </tr>
                            <?php $i++; ?>
                            <?php } ?>
                        </tbody>
