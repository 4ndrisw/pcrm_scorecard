...
<?php 
    ...
    $scorecards = $CI->tasks_history_model->get_daily_update_status_perstaff();

?>


<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('daily_update_status_perstaff'); ?>">
    <?php if(staff_can('view', 'scorecards') || staff_can('view_own', 'scorecards')) { ?>
    <div class="panel_s scorecards-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('daily_update_status_perstaff'); ?></p>
                    ...
                    <table id="widget-<?php echo create_widget_id(); ?>" class="table dt-table" data-order-col="1" data-order-type="desc">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo _l('update_status'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($scorecards as $scorecard) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $scorecard->update_status; ?> </td>
                                </tr>
                            <?php $i++; ?>
                            <?php } ?>
                        </tbody>
