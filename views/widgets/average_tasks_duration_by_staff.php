...
<?php
    ...
    $scorecards = $CI->tasks_duration_model->get_average_tasks_duration_by_staff(get_staff_user_id());
?>
...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('tasks_duration_by_staff'); ?>">
    ...
    <div class="panel_s scorecards-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('average_tasks_duration_by_staff'); ?></p>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($scorecards as $scorecard) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo round($scorecard['avg_duration'],PHP_ROUND_HALF_DOWN); ?>
                                        <?php //echo round($scorecard['avg_duration'],PHP_ROUND_HALF_DOWN) .' ' . _l('days'); ?>
                                    </td>
                                </tr>
                            <?php $i++; ?>
                            <?php } ?>
