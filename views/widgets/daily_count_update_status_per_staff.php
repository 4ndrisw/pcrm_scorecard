...
<?php 
    ...
    $scorecards = $CI->tasks_history_model->get_daily_count_update_status_per_staff();

 //   echo $scorecards; return;
?>


<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('daily_count_update_status_per_staff'); ?>">
    <?php if(staff_can('view', 'scorecards') || staff_can('view_own', 'scorecards')) { ?>
    <div class="panel_s scorecards-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('daily_count_update_status_per_staff'); ?></p>
