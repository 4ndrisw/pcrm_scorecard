...
<?php
    ...
    $scorecards = $CI->company_recapitulation_model->get_daily_task_completed();
?>

<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('daily_completed_task'); ?>">
    <?php if(staff_can('view', 'scorecards') || staff_can('view_own', 'scorecards')) { ?>
    <div class="panel_s scorecards-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('daily_completed_task'); ?></p>
                    ...
                    <table id="widget-<?php echo create_widget_id(); ?>" class="table dt-table" data-order-col="1" data-order-type="desc">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($scorecards as $scorecard) { ?>
                                <tr>
                                    <td> <?php echo $i; ?></td>
                                    <td><?php echo $scorecard['dtc_finished']; ?></td>
